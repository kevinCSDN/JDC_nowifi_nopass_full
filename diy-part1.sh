...
sed -i '1s|https://git.openwrt.org/feed/packages.git|https://github.com/immortalwrt/packages.git;openwrt-23.05|' feeds.conf.default
sed -i '2s|https://git.openwrt.org/project/luci.git|https://github.com/immortalwrt/luci.git;openwrt-23.05|' feeds.conf.default
